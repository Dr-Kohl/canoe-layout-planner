...
export default function LayoutPlanner() {
  ...
  return <main>
    ...
    <section className="intro"><p className="kicker">Plan the cuts before you build.</p><p>Your team receives <strong>55 feet of 41-inch-wide waxed paper board</strong>. Reserve the skin first, then see how much remains for the 10-inch rolled frame pieces.</p></section>
